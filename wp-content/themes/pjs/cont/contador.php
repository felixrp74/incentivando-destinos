...
$rs=mysql_query($sql) or die("Problemas al ejecutar select SQL 111111 ".mysql_error());
...
mysql_query($sql) or die("Problemas al ejecutar la insert SQL 22222 ".mysql_error());
...
mysql_query($sql) or die("Problemas al ejecutar update SQL 33333 ".mysql_error());

}

$sql="select SUM(num_votos) from contador"; //Obtenemos la suma de todas las visitas

$rs=mysql_query($sql) or die("Problemas al ejecutar select SQL 44444 ".mysql_error());
