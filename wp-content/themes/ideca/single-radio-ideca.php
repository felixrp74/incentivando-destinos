...
<div class="container">	
	...
	<div class="row">
		...
		<div class="col-sm-8 fuente">
        	...
        	<div class="f-rad" style="text-align:justify;">
			<?php 
				echo $conten;
			?>
			</div>
			...
			<div class="otro-rad">
				<h3 class="tit dorado">Otros Relacionados</h3>
	            <table class="table table-hover">
					<tbody>
			            <?php $custom_query =  new WP_Query( array( 'post_type' => 'any', 'post__not_in' => array(get_the_ID()),'category_name'=>'radio-ideca', 'posts_per_page'=>7 ,'orderby'=>'date', 'order' => 'DESC','paged' => get_query_var('page')) ); ?>  	            
