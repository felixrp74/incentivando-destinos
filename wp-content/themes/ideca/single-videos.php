...
<div class="container">	
	...
	<div class="row">
		...
		<div class="col-sm-8 fuente">
			...
			<div class="otro-rad">
				<h3 class="tit dorado">Otros Videos Relacionados</h3>
				<table class="table table-hover table-condensed tablita">
					<tbody>
			            <?php $custom_query =  new WP_Query( array( 'post_type' => 'any', 'post__not_in' => array(get_the_ID()),'category_name'=>'videos', 'posts_per_page'=>7 ,'orderby'=>'date', 'order' => 'DESC','paged' => get_query_var('page')) ); ?>  	            
