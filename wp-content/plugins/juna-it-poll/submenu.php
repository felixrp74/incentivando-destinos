			...
			if($_SERVER["REQUEST_METHOD"]=="POST")
			{
				?>
				 	...
				 	<tr>
				 		...
				 		<th style="font-size:18px;"> <b> <i> Respuestas </i> </b> </th>
				 		<th style="font-size:18px;"> <b> <i> Votos  </i> </b> </th>	 		
				 	</tr>
