...
<div id="Juna_IT_Poll_main_first_div"> 
	<div class="Juna_IT_Poll_Add_Poll_Footer_Div">
		<a href="http://juna-it.com" target="_blank"<abbr title="Click to Visit"><img src="http://juna-it.com/image/logo-orange.png" class="Juna_IT_Logo_Orange"></a>
			<br><br><br><br><br>
		<span class="Polls_Title_Span">Pregunta:</span> 
		<input type="text" class="Juna_IT_Poll_search_text_field" id="Juna_IT_Poll_search_text_field" onclick="Juna_IT_Poll_Search_Question()" placeholder="Buscar">
		<input type="button" class="Juna_IT_Poll_Reset_button" value="Buscar" onclick="Juna_IT_Poll_Reset_Button_Clicked()">
		<span class="searched_question_does_not_exist" id="searched_question_does_not_exist"></span>
		<input type="button" class="Juna_IT_Poll_Add_Poll_button" value="Crear nueva encuesta" onclick="Juna_IT_Poll_Create_New_Poll_Clicked()">
	</div>
	<table class = 'Juna_IT_Poll_Main_Table'>
		<tr class="Juna_IT_Poll_first_row">
			<td class='Juna_IT_Poll_main_id_item'><B><I>Nro</I></B></td>
			<td class='Juna_IT_Poll_main_title_item'><B><I>Titulo de Encuesta</I></B></td>
			<td class='Juna_IT_Poll_main_type_item'><B><I>Tipo</I></B></td>	
			<td class='Juna_IT_Poll_main_type_item'><B><I>Codigo Encuesta</I></B></td>		
			<td class='Juna_IT_Poll_main_actions_item'><B><I>Acciones</I></B></td>
		</tr>
	</table>
	<table class = 'Juna_IT_Poll_Table'>
		...
		<tr>
			...
			<td class='Juna_IT_Poll_edit_item' onclick="Edit_Juna_IT_Poll(<?php echo $Juna_IT_Poll_title_table[$i]->id; ?>,<?php echo $Juna_IT_Poll_title_table[$i]->Juna_IT_Poll_Plugin_Type_Text_Readonly; ?>)"><B><I>Editar</I></B></td>
			<td class='Juna_IT_Poll_delete_item' onclick="Delete_Juna_IT_Poll(<?php echo $Juna_IT_Poll_title_table[$i]->id ; ?>)"><B><I>Eliminar</I></B></td>
		</tr>
		<?php } ?>
	</table>
...
<div id="Juna_IT_Poll_main_second_div">
	<form method="post" id="Juna_IT_Poll_Admin_Form" enctype="multipart/form-data">
		<div class="Juna_IT_Poll_Add_Poll_Footer_Div1">
			...
			<br>
			<span class="Add_Polls_Title_Span">Pregunta:</span> 
			<input type="text" class="Juna_IT_Poll_Add_Question_Field" id="Juna_IT_Poll_Add_Question_Field" name="Juna_IT_Poll_Add_Question_Field" onclick="Juna_IT_Poll_Add_Question_Field_Click()" required>
				<br><br><br>
			<input type="button" value="Elegir tipo de Encuesta" id="Juna_IT_Poll_Admin_Menu_Button_1" class="Juna_IT_Poll_Choose_Poll_Type_Button" onclick="Juna_IT_Poll_Buttons_Clicked(1)">
			<input type="button" value="Agregar respuestas" id="Juna_IT_Poll_Admin_Menu_Button_2" class="Juna_IT_Poll_Add_Answers_Button" onclick="Juna_IT_Poll_Buttons_Clicked(2)">
			...
			<input type='submit' id='Juna_IT_Poll_Save_Button' class="Juna_IT_Poll_Save_Button" value='Guardar Encuesta' name="Add_new_Juna_IT_Poll_Save_button"/>
		</div>
		...
		<div class='plugins_type' id='plugins_type1' >
			<div class='questions_title' style='margin-top:10px; text-align:center; color:black;padding:5px;'><span style="width:250px;display:block; position:relative;word-wrap: break-word;line-height: 25px;" class="Juna_IT_Poll_Question_Field_Span">Pregunta?</span></div>	
			
			<div class='Juna_IT_Poll_PT1_Div1 Juna_IT_Poll_Answer_Div_P Juna_IT_Poll_Answer_Div' style="margin-top:0px; height:40px;"><input class='Juna_IT_Poll_Radio' style="margin:9px;" type='radio' name="answer"><span id='Juna_IT_Poll_PT1_Answer_1'>Pregunta 1</span></div>
			<div class='Juna_IT_Poll_PT1_Div2 Juna_IT_Poll_Answer_Div_P Juna_IT_Poll_Answer_Div' style="margin-top:0px; height:40px;"><input class='Juna_IT_Poll_Radio' style="margin:9px;" type='radio' name="answer"><span id='Juna_IT_Poll_PT1_Answer_2'>Pregunta 2</span></div>
		...
		<div class='plugins_type' id='plugins_type2'>
			...
			<div  class='Juna_IT_Poll_Answer_Div_P Juna_IT_Poll_Answer_Div' id='Juna_IT_Poll_PT2_Answer_1' style='padding:0px;margin-top:0px; color:black;height:30px; background-color: #f83056;border-radius:10px; text-align:center;'>Respuesta 1</div>
			<div  class='Juna_IT_Poll_Answer_Div_P Juna_IT_Poll_Answer_Div' id='Juna_IT_Poll_PT2_Answer_2' style='padding:0px;margin-top:0px; color:black;height:30px; background-color: #fd5f05;border-radius:10px; text-align:center;'>Respues 2</div>
		...
		<fieldset id='Juna_IT_Poll_Add_Answers_Field' class="Juna_IT_Poll_Add_Answers_Field">	
			...
			<table class="Juna_IT_Poll_Add_Remove_Button_Table">
				<tr>
					<td>
						<input type="button" id="Juna_IT_Poll_Add_Answer_Button"    value="Agregar respuestas"    onclick="Juna_IT_Poll_Add_Answer_Button_Click()">
						<input type="button" id="Juna_IT_Poll_Remove_Answer_Button" value="Eliminar respuesta" onclick="Juna_IT_Poll_Remove_Answer_Button_Click()">
					</td>
				</tr>
			</table>		 	
		</fieldset>
